...
void luaRegister() {
	...
	assingGlobalFunction( "SetRenderTextureTexture", ltexturesSetRenderTextureTexture );
	assingGlobalFunction( "SetRenderTextureDepthTexture", ltexturesSetRenderTextureDepthTexture );
